package MultithreadProgrammingCore.atomicClass.ABAProblem;
 ...
 * 我们来想象一下这种场景:
 *
 *      https://img-blog.csdnimg.cn/img_convert/ce4c89e118a025868a236b578d77bdc7.png
 *
 ...
 *                      System.out.println(reference.compareAndSet(a, b, 2, 3)); // CAS操作时不仅仅需要提供预期值和修改值 还要提供预期版本号和新的版本号
 *
 *                  }
 *
 * 至此 有关原子类的讲解就到这里
